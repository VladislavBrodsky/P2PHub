...
export const ReferralWidget = ({ onInvite, onShowQR }: ReferralWidgetProps) => {
    ...
    return (
        <div className="mt-2 mb-4 relative w-full h-12">
            <button
                onClick={onInvite}
                className="w-full h-12 rounded-2xl flex items-center justify-center gap-2.5 font-bold text-white active:scale-95 transition-all relative overflow-hidden group shadow-premium bg-brand-blue hover:brightness-110 will-change-transform"
            >
                ...
                <span className="relative z-10 text-caption tracking-widest uppercase font-bold">{t('referral.widget.invite')}</span>
