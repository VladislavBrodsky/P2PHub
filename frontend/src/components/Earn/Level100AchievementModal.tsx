            ...
            {isOpen && (
                <div className="fixed inset-0 z-100 flex items-end sm:items-center justify-center overflow-hidden">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-lg sm:max-w-md bg-white dark:bg-[#020617] rounded-t-[3rem] sm:rounded-[3rem] text-center shadow-[0_-20px_40px_rgba(0,0,0,0.3)] border-t border-slate-200 dark:border-white/10 sm:border max-h-[90vh] flex flex-col"
                    >
