    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-6 duration-700 pt-4">
            ...
            <div className="relative group overflow-hidden rounded-[2rem] p-1 shadow-xl">
                ...
                <div className="relative z-10 glass-panel-premium rounded-[1.8rem] border-white/20 p-4 overflow-hidden">
                    ...
                    <div className="relative z-20 flex flex-col items-center text-center space-y-5">
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-900/10 dark:bg-white/10 backdrop-blur-md border border-slate-900/10 dark:border-white/10 text-[8px] font-black uppercase tracking-[0.15em] text-blue-800 dark:text-white">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-slate-700 dark:text-slate-300 text-[9px] font-bold leading-relaxed max-w-[260px] mx-auto opacity-90 uppercase tracking-wide">
                        ...
                        <div className="flex items-center gap-4 pt-1">
                            <div className="flex flex-col items-center">
                                <span className="text-[11px] font-black text-slate-900 dark:text-white">100</span>
                                <span className="text-[6px] font-black text-slate-600 dark:text-blue-100/60 uppercase tracking-widest">{t('academy.stat_levels')}</span>
                            </div>
                            <div className="w-px h-4 bg-slate-900/10 dark:bg-white/10" />
                            <div className="flex flex-col items-center">
                                <span className="text-[11px] font-black text-blue-600 dark:text-blue-400">20+</span>
                                <span className="text-[6px] font-black text-slate-600 dark:text-blue-100/60 uppercase tracking-widest">{t('academy.stat_free')}</span>
                            </div>
                            <div className="w-px h-4 bg-slate-900/10 dark:bg-white/10" />
                            <div className="flex flex-col items-center">
                                <span className="text-[11px] font-black text-orange-600 dark:text-orange-400">PRO</span>
                                <span className="text-[6px] font-black text-slate-600 dark:text-blue-100/60 uppercase tracking-widest">{t('academy.stat_elite')}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {(isFooterVisible && !isKeyboardOpen) && (
                <div className="fixed bottom-32 left-1/2 -translate-x-1/2 z-40 w-full max-w-[240px] px-2 pointer-events-none">
                    <motion.div
                        initial={{ y: 50, opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
                        className="glass-panel-premium rounded-2xl p-2 border-white/20 shadow-[0_15px_40px_rgba(0,0,0,0.3)] flex items-center justify-between gap-3 bg-white/80 dark:bg-slate-900/40 backdrop-blur-3xl ring-1 ring-white/10 pointer-events-auto"
                    >
