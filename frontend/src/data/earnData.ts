...
export const ACHIEVEMENTS = [
    // Early Career
    { id: 'early_1', level: 1, reward: 'referral.rewards.items.onboard_1', icon: CheckCircle2, color: 'text-emerald-400' },
    { id: 'early_5', level: 5, reward: 'referral.rewards.items.ref_node', icon: UserPlus, color: 'text-blue-400' },
    { id: 'early_10', level: 10, reward: 'referral.rewards.items.silver_badge', icon: Shield, color: 'text-slate-300' },

    // Growth Tiers
    { id: 'growth_15', level: 15, reward: 'referral.rewards.items.viral_tsunami', icon: Zap, color: 'text-yellow-400' },
    { id: 'growth_20', level: 20, reward: 'referral.rewards.items.network_pro', icon: Users, color: 'text-indigo-400' },
    { id: 'growth_25', level: 25, reward: 'referral.rewards.items.fee_discount', icon: CreditCard, color: 'text-emerald-500' },
    ...
    { id: 'elite_50', level: 50, reward: 'referral.rewards.items.black_card', icon: CreditCard, color: 'text-neutral-900 dark:text-white' },
];

export const MILESTONES = [
    { level: 60, reward: 'referral.rewards.items.grandmaster', icon: Crown, color: 'text-purple-500' },
    { level: 70, reward: 'referral.rewards.items.vip_status', icon: Star, color: 'text-rose-500' },
    { level: 80, reward: 'referral.rewards.items.premium_access', icon: Shield, color: 'text-emerald-400' },
    { level: 90, reward: 'referral.rewards.items.immortal_tier', icon: Zap, color: 'text-blue-600' },
    { level: 100, reward: 'referral.rewards.items.platinum_physical', icon: Trophy, color: 'text-slate-100' },
];
