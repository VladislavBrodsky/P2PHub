            ...
            {isOpen && (
                <div className="fixed inset-0 z-100 flex items-end sm:items-center justify-center sm:p-4 px-0 py-0">
                    ...
                    <m.div
                        ...
                        className="w-full sm:max-w-sm bg-white dark:bg-slate-900 rounded-t-2xl sm:rounded-2xl relative shadow-2xl overflow-hidden flex flex-col max-h-[90vh] pb-[calc(var(--spacing-safe-bottom,20px)+16px)] sm:pb-5"
                    >
                        {/* Header / Close */}
