                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative z-10">
                                    ...
                                    <motion.div
                                        ...
                                        className="pro-card-extreme rounded-[3rem] p-10 border border-indigo-500/30 group relative flex flex-col shadow-3xl col-span-1 sm:col-span-2 holographic-shine border-gradient-pro bg-slate-100/30 dark:bg-indigo-500/[0.03]"
                                    >
