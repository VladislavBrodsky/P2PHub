                    ...
                    {infoModal ? (
                        <div className="vibing-premium-panel p-5 w-full max-w-[280px] rounded-2xl text-center relative overflow-hidden shadow-2xl border-white/20">
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                ...
                                <h3 className={`text-[clamp(1rem,4vw,1.125rem)] font-bold uppercase mb-2 tracking-tighter leading-none ${infoModal.color === 'emerald' ? 'text-emerald-500' : infoModal.color === 'amber' ? 'text-amber-500' : 'text-blue-500'}`}>{infoModal.title}</h3>
                                <div className="px-1 mb-6">
                                    <p className="text-[clamp(0.6rem,2.2vw,0.7rem)] text-slate-600 dark:text-white/70 uppercase font-bold tracking-widest leading-normal overflow-y-auto max-h-[100px] scrollbar-hide">{infoModal.desc}</p>
                                </div>
                                <button
                        ...
                        <div className="vibing-premium-panel p-5 w-full max-w-[280px] rounded-2xl text-center relative">
                            ...
                            <h2 className="text-[clamp(0.875rem,3.5vw,1rem)] font-bold text-slate-900 dark:text-white uppercase mb-2">
                            ...
                            <p className="text-[clamp(0.6rem,2.2vw,0.7rem)] text-slate-500 dark:text-white/40 uppercase font-bold tracking-widest mb-6 px-4">
