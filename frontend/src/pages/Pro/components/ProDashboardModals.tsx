                                            ...
                                            <motion.div key="pro-tg" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 overflow-hidden shadow-xs flex flex-col">
                                                <div className="flex items-center gap-3 p-4 sm:p-5 bg-sky-500/5 border-b border-sky-500/15">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-label font-bold text-slate-900 dark:text-white uppercase tracking-tight leading-none">Telegram Primary Node</p>
                                                    ...
                                                    <button onClick={() => { selection(); setShowManual('setup_tg'); }} className="text-label text-sky-500 font-bold uppercase tracking-widest underline shrink-0">Guide</button>
                                                </div>
                                        ...
                                        {activeProPlatform === 'x' && (
                                            <motion.div key="pro-x" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 overflow-hidden shadow-xs flex flex-col">
                                                <div className="flex items-center gap-3 p-4 sm:p-5 bg-indigo-500/5 border-b border-indigo-500/15">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-label font-bold text-slate-900 dark:text-white uppercase tracking-tight leading-none">X Global Broadcast</p>
                                                    ...
                                                    <button onClick={() => { selection(); setShowManual('setup_x'); }} className="text-label text-indigo-500 font-bold uppercase tracking-widest underline shrink-0">Guide</button>
                                                </div>
                                                ...
                                                {activePlusPlatform === 'linkedin' && (
                                                    <motion.div key="plus-li" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 overflow-hidden shadow-xs flex flex-col">
                                                        <div className="flex items-center gap-3 p-4 sm:p-5 bg-indigo-500/5 border-b border-indigo-500/15">
                                                            ...
                                                            <button onClick={() => { selection(); setShowManual('setup_linkedin'); }} className="text-label text-indigo-500 font-bold uppercase tracking-widest underline shrink-0">{t('pro_dashboard.setup.linkedin.guide')}</button>
                                                        </div>
                                                        <div className="space-y-1.5">
                                                ...
                                                {activePlusPlatform === 'pinterest' && (
                                                    <motion.div key="plus-pi" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 overflow-hidden shadow-xs flex flex-col">
                                                        <div className="flex items-center gap-3 p-4 sm:p-5 bg-rose-500/5 border-b border-rose-500/15">
                                                            ...
                                                            <button onClick={() => { selection(); setShowManual('setup_pinterest'); }} className="text-label text-rose-500 font-bold uppercase tracking-widest underline shrink-0">{t('pro_dashboard.setup.pinterest.guide')}</button>
                                                        </div>
                                                        <div className="space-y-1.5">
                                                ...
                                                {activePlusPlatform === 'threads' && (
                                                    <motion.div key="plus-tr" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 overflow-hidden shadow-xs flex flex-col">
                                                        <div className="flex items-center gap-3 p-4 sm:p-5 bg-emerald-500/5 border-b border-emerald-500/15">
                                                            ...
                                                            <button onClick={() => { selection(); setShowManual('setup_threads'); }} className="text-label text-emerald-500 font-bold uppercase tracking-widest underline shrink-0">{t('pro_dashboard.setup.threads.guide')}</button>
                                                        </div>
                                                        <div className="space-y-1.5">
                                                ...
                                                {activePlusPlatform === 'facebook' && (
                                                    <motion.div key="plus-fb" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 overflow-hidden shadow-xs flex flex-col">
                                                        <div className="flex items-center gap-3 p-4 sm:p-5 bg-blue-500/5 border-b border-blue-500/15">
                                                            ...
                                                            <button onClick={() => { selection(); setShowManual('setup_facebook'); }} className="text-label text-blue-500 font-bold uppercase tracking-widest underline shrink-0">{t('pro_dashboard.setup.facebook.guide')}</button>
                                                        </div>
                                                        <div className="space-y-1.5">
                                                ...
                                                {activePlusPlatform === 'discord' && (
                                                    <motion.div key="plus-dc" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 overflow-hidden shadow-xs flex flex-col">
                                                        <div className="flex items-center gap-3 p-4 sm:p-5 bg-[#5865F2]/5 border-b border-[#5865F2]/15">
                                                            ...
                                                            <button onClick={() => { selection(); setShowManual('setup_discord'); }} className="text-label text-[#5865F2] font-bold uppercase tracking-widest underline shrink-0">{t('pro_dashboard.setup.discord.guide')}</button>
                                                        </div>
                                                        <div className="space-y-1.5">
                            ...
                            <div className="px-5 py-4 bg-slate-50/80 dark:bg-slate-900/80 border-t border-slate-100 dark:border-white/5 backdrop-blur-sm">
                                {(setupTab === 'pro' || status?.is_pro_plus) ? (
                                    <button
                                        ...
                                        disabled={isSaving}
                                        className="w-full h-13 bg-linear-to-r from-indigo-600 to-indigo-800 hover:from-indigo-500 hover:to-indigo-700 text-white rounded-2xl font-bold text-label uppercase tracking-[0.25em] shadow-xl shadow-indigo-500/25 active:scale-[0.98] transition-all flex items-center justify-center gap-2.5 disabled:opacity-60"
                                    >
                                        {isSaving ? (
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-y-auto no-scrollbar p-5 sm:p-8 space-y-6">
                                ...
                                {marketAudit.error ? (
                                    <div className="flex flex-col items-center justify-center py-12 px-6 text-center space-y-4">
                                        ...
                                        <h4 className="text-lg font-bold text-slate-900 dark:text-white uppercase">Intelligence Error</h4>
                                    ...
                                    <>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div className="col-span-1 sm:col-span-2 p-6 bg-linear-to-br from-indigo-500/10 to-purple-500/5 dark:bg-white/2 rounded-2xl border border-indigo-500/10 dark:border-white/5 relative overflow-hidden group shadow-sm">
                                                ...
                                                <div className="flex items-center gap-2 mb-3">
                                                    ...
                                                    <h4 className="text-label font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-[0.2em]">Strategy Intelligence</h4>
                                                </div>
                                        ...
                                        <div className="space-y-4 pt-4">
                                            <div className="flex items-center justify-between px-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <h4 className="text-label font-bold text-slate-900 dark:text-white uppercase tracking-widest">Global Live Tracker</h4>
                                                </div>
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1 space-y-2.5">
                                                            <div className="flex flex-wrap items-center gap-2">
                                                                ...
                                                                {idx === 0 && <span className="px-2 py-0.5 bg-amber-500/10 rounded-md text-label font-bold text-amber-500 uppercase tracking-[0.2em] animate-bounce">Hot Now</span>}
                                                            </div>
                                        ...
                                        <div className="p-6 bg-linear-to-r from-indigo-600 via-purple-600 to-indigo-600 rounded-2xl border border-white/20 space-y-4 relative overflow-hidden group shadow-xl">
                                            ...
                                            <div className="flex items-center gap-3 relative z-10">
                                                ...
                                                <h4 className="text-caption font-bold text-white uppercase tracking-widest">Growth Imperative</h4>
                                            </div>
                            ...
                            <div className="p-6 sm:p-8 bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-white/5 space-y-4 sticky bottom-0 z-20">
                                <button
                                    ...
                                    className="w-full h-13 vibing-blue-animated rounded-2xl font-bold text-white text-label uppercase tracking-[0.2em] shadow-xl active:scale-95 transition-all flex items-center justify-center gap-3 hover:gap-5 group"
                                >
                                    Initiate Viral Protocol <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                                </button>
                                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-1">
                                    <div className="flex items-center gap-2 text-emerald-500 font-bold text-label uppercase tracking-[0.2em]">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <span className="text-label font-bold text-slate-400 uppercase tracking-widest tabular-nums">{status?.pro_tokens ?? 0}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex-1 overflow-y-auto no-scrollbar p-6 sm:p-8 space-y-6">
                                ...
                                {headlineResult && (
                                    ...
                                    >
                                        ...
                                        <h4 className="text-label font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Synthesized Headline</h4>
                        ...
                        >
                            ...
                            <div className="p-6 sm:p-8 border-b border-slate-100 dark:border-white/5 flex justify-between items-center bg-linear-to-r from-amber-500/5 to-transparent">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tight leading-none mb-1">{t('pro_dashboard.tools.bio.title')}</h3>
                                        <div className="flex items-center gap-2">
                                            <p className="text-label font-bold text-amber-600 dark:text-amber-400 uppercase tracking-[0.2em] opacity-80">
                            ...
                            <div className="flex-1 overflow-y-auto no-scrollbar p-6 sm:p-8 space-y-6">
                                ...
                                {bioResult && (
                                    ...
                                    >
                                        ...
                                        <h4 className="text-label font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Synthesized Bio</h4>
                                        <p className="text-sm font-bold text-slate-900 dark:text-white leading-tight">
                                            {bioResult}
                                        </p>
                                        <button
                                            ...
                                            className="text-label font-bold text-amber-500 uppercase tracking-widest hover:text-amber-600 transition-colors"
                                        >
                                            Copy to Clipboard
                                        </button>
                                    </motion.div>
                            ...
                            <div className="p-6 sm:p-8 bg-slate-50 dark:bg-black/40 border-t border-slate-100 dark:border-white/5">
                                <button
                                    ...
                                    className="w-full h-13 bg-amber-600 hover:bg-amber-700 text-white rounded-2xl font-bold text-label uppercase tracking-[0.15em] shadow-xl shadow-amber-500/20 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:opacity-70 disabled:grayscale"
                                >
                                    {isGeneratingBio ? (
                                        <>
                                            <Loader2 className="animate-spin" size={16} />
