                                        ...
                                        {activeProPlatform === 'tg' && (
                                            <motion.div key="pro-tg" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 sm:p-5 rounded-[1.5rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 space-y-4 shadow-xs">
                                                <div className="flex items-center gap-3 bg-sky-500/5 -mx-4 -mt-4 p-4 border-b border-sky-500/15">
                                                    ...
                                                    <button onClick={() => { selection(); setShowManual('setup_tg'); }} className="text-label text-sky-500 font-bold uppercase tracking-widest underline shrink-0">{t('pro_dashboard.setup.guide_btn')}</button>
                                                </div>
                                                <div>
                                        ...
                                        {activeProPlatform === 'x' && (
                                            <motion.div key="pro-x" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 sm:p-5 rounded-[1.5rem] border border-slate-200/60 dark:border-white/10 bg-slate-50 dark:bg-black/20 space-y-4 shadow-xs">
                                                <div className="flex items-center gap-3 bg-indigo-500/5 -mx-4 -mt-4 p-4 border-b border-indigo-500/15">
                                                    ...
                                                    <button onClick={() => { selection(); setShowManual('setup_x'); }} className="text-label text-indigo-500 font-bold uppercase tracking-widest underline shrink-0">{t('pro_dashboard.setup.guide_btn')}</button>
                                                </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="p-6 sm:p-8 bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-white/5 space-y-4 sticky bottom-0 z-20">
                                    ...
                                    >
                                        {t('pro_dashboard.tools.audit.initiate_btn')} <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                                    </button>
                                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-1">
                                        <div className="flex items-center gap-2 text-emerald-500 font-bold text-label uppercase tracking-[0.2em]">
                                            <CheckCircle2 size={12} />
                                            {t('pro_dashboard.tools.audit.verified_status')}
                                        </div>
                                        <button
                                            onClick={() => { selection(); handleRefreshAudit(); }}
                                            disabled={isAuditing}
