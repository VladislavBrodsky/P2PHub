...
export default function CommunityPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen pt-[20px] px-4 pb-12 relative transition-colors duration-300 lg:max-w-4xl xl:max-w-5xl lg:mx-auto w-full">



            {/* Top Navigation / Switcher */}
            <div className="relative z-20 mb-2 mt-0 flex justify-center">
