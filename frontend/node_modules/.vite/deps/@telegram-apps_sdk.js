...
var Ms = "ERR_INVALID_VALUE";
var Is = "ERR_UNEXPECTED_VALUE";
var Ds = "ERR_UNEXPECTED_TYPE";
var Qn = "ERR_PARSE";
function Jn(e, t) {
  const n = {};
  for (const o in e) {
...
var Nt = j("date", (e) => e instanceof Date ? e : new Date(Ue()(e) * 1e3));
function Kn(e, t) {
...
var ks = (e) => {
  const t = Ue(), n = Ue(true), o = L(), s = L(true), r = Ns(true), a = He(mt({
...
var Us = "ERR_INVALID_VALUE";
var qs = "ERR_UNEXPECTED_VALUE";
var Fs = "ERR_UNEXPECTED_TYPE";
var to = "ERR_PARSE";
function no(e, t) {
  const n = {};
  for (const o in e) {
...
var Ws = I("date", (e) => e instanceof Date ? e : new Date(de()(e) * 1e3));
function so(e, t) {
...
var Gs = (e) => {
  const t = de(), n = de(true), o = R(), s = R(true), r = qe(true), a = M(ht({
    addedToAttachmentMenu: r,
    allowsWriteToPm: r,
    firstName: o,
    id: t,
...
var Ks = (e) => {
  const t = R(), n = R(true), o = qe(true);
  return so({
    botInline: ["tgWebAppBotInline", o],
    defaultColors: ["tgWebAppDefaultColors", Tn(true)],
    fullscreen: ["tgWebAppFullscreen", o],
    initData: ["tgWebAppData", Gs(true)],
...
function Zs(e) {
  ...
  return i.set("tgWebAppPlatform", e.platform), i.set("tgWebAppThemeParams", At(e.themeParams)), i.set("tgWebAppVersion", e.version), t && i.set("tgWebAppData", t), n && i.set("tgWebAppStartParam", n), typeof o == "boolean" && i.set("tgWebAppShowSettings", o ? "1" : "0"), typeof s == "boolean" && i.set("tgWebAppBotInline", s ? "1" : "0"), typeof r == "boolean" && i.set("tgWebAppFullscreen", r ? "1" : "0"), a && i.set("tgWebAppDefaultColors", At(a)), i.toString();
}
var ro = M({
  eventType: R(),
  eventData: (e) => e
...
var or = (e, t, n) => t in e ? nr(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var co = (e, t, n) => or(e, typeof t != "symbol" ? t + "" : t, n);
var l = class uo extends Error {
  constructor(t, n, o) {
    super(
      typeof n == "object" ? n.message : n || t,
      {
...
var dr = "ERR_METHOD_UNSUPPORTED";
var mr = "ERR_RETRIEVE_LP_FAILED";
var hr = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var go = "ERR_UNKNOWN_ENV";
var br = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var gr = ne("https://web.telegram.org");
function Ht(e, t) {
...
function Bn(e) {
  ...
  return b.withFn(async () => {
    if (io(window))
      return true;
    try {
      return await Ut("web_app_request_theme", "theme_changed", { timeout: 100 }), true;
    } catch {
      return false;
    }
  }, e);
...
var y = (e, t, n) => (n || (n = {}), n.postEvent || (n.postEvent = f), Ut(e, t, n));
var f = (e, t) => Ao()(e, t);
function N(e) {
  return _(() => Q(e, V()));
}
var ce = "ERR_POPUP_INVALID_PARAMS";
var Ft = "ERR_INVALID_URL";
var Dr = "ERR_INVALID_SLUG";
var Nr = "ERR_DATA_INVALID_SIZE";
var kr = "ERR_ACCESS_DENIED";
var q = "ERR_ALREADY_REQUESTING";
var Wt = "ERR_ALREADY_OPENED";
var xr = "ERR_ALREADY_MOUNTING";
var Vr = "ERR_VARS_ALREADY_BOUND";
var Lr = "ERR_NOT_AVAILABLE";
var jr = "ERR_NOT_INITIALIZED";
var In = "ERR_NOT_SUPPORTED";
var Hr = "ERR_NOT_MOUNTED";
var Ur = "ERR_FULLSCREEN_FAILED";
var qr = "ERR_EMOJI_STATUS_SET_FAILED";
function Dn() {
...
var Ge = "web_app_setup_back_button";
var vo = "back_button_pressed";
var ze = "backButton";
var $t = c(false);
var me = c(false);
var Fr = N(Ge);
...
var Gr = Gt("mount", () => {
  me() || (zt(D() && P(ze) || false), me.set(true));
});
function zt(e) {
...
var Nn = "web_app_biometry_get_info";
var Xr = h(
  "requestBiometry",
...
var ea = "web_app_biometry_request_access";
var ta = "web_app_biometry_open_settings";
var na = "web_app_biometry_update_token";
var Yt = "biometry_info_received";
var ee = "biometry";
var oa = N(Ye);
var sa = H(ee);
var ra = B(ee, Ye);
...
var Bo = Ze(Xe, he);
var _a = H(Xe);
var fa = Bo("disableConfirmation", () => {
  Zt(false);
});
var da = Bo("enableConfirmation", () => {
  Zt(true);
});
var ma = _a("mount", () => {
  he() || (Zt(
...
var Mo = "web_app_invoke_custom_method";
var et = B("cloudStorage", Mo);
var ba = N(Mo);
var ga = et("deleteItem", (e, t) => {
...
var wa = et("getItem", Ea);
var Sa = et("getKeys", (e) => se("getStorageKeys", {}, e).then(js(L())()));
var ya = et("setItem", (e, t, n) => se("saveStorageValue", {
  key: e,
  value: t
}, n).then());
...
var Oe = "web_app_trigger_haptic_feedback";
var Xt = B("hapticFeedback", Oe);
var Aa = N(Oe);
var Ca = Xt(
  "impactOccurred",
  (e) => {
...
async function ko(e, t, n) {
  ...
  if (t === "url") {
    ...
    o = e, n = t;
  return Ne.set(true), y(tn, "invoice_closed", {
    ...n,
    params: { slug: o },
    capture: (s) => o === s.slug
...
var ja = C("accentTextColor");
var nn = C("bgColor");
var on = C("buttonColor");
var Lo = C("buttonTextColor");
var jo = C("bottomBarBgColor");
var Ha = C("destructiveTextColor");
var Ua = C("headerBgColor");
var qa = C("hintColor");
var Fa = _(() => {
  const { bgColor: e } = U();
  return !e || Vo(e);
...
var Wa = C("linkColor");
var Fe = C("secondaryBgColor");
var Ga = C("sectionBgColor");
var za = C("sectionHeaderTextColor");
var Qa = C("sectionSeparatorColor");
var Ja = C("subtitleTextColor");
var Ya = C("textColor");
function Y(e) {
  return _(() => sn()[e]);
}
...
var ge = c(false);
var Ka = Y("backgroundColor");
var Za = Y("hasShineEffect");
var Xa = Y("isEnabled");
var ei = Y("isLoaderVisible");
var ti = Y("isVisible");
var ni = Y("text");
var oi = Y("textColor");
var si = "web_app_setup_main_button";
var Ho = "main_button_pressed";
var tt = "mainButton";
var rn = H(tt);
var ri = Ze(tt, ge);
var ai = rn("mount", () => {
...
var di = fi(
  ...
  (e) => {
    ...
    return n(), U.sub(n), ke.set(true), () => {
      t(Lt), U.unsub(n), ke.set(false);
    };
  }
);
var qo = _i("mount", () => {
...
var Ot = "web_app_set_background_color";
var Pt = "web_app_set_bottom_bar_color";
var Ve = "web_app_set_header_color";
var Qo = "visibility_changed";
var Pe = "miniApp";
var ln = {
  any: [
    Ot,
...
var Si = gi(
  ...
  () => {
    if (!ye()) {
      const e = D() && P(Pe);
      qo(), Ko.ifAvailable(e ? e.backgroundColor : "bg_color"), Zo.ifAvailable(e ? e.bottomBarColor : "bottom_bar_bg_color"), Xo.ifAvailable(e ? e.headerColor : "bg_color"), ot.set(e ? e.isActive : true), E(Qo, Yo), ye.set(true);
    }
  }
);
var yi = Jo("ready", () => {
...
var Ri = "web_app_close_scan_qr_popup";
var _n = "web_app_open_scan_qr_popup";
var Oi = "scan_qr_popup_closed";
var Pi = "qr_text_received";
var es = B("qrScanner", _n);
var Bt = es("close", () => {
  X.set(false), f(Ri);
});
var X = c(false);
...
var Ae = c(false);
var Di = F("backgroundColor");
var Ni = F("hasShineEffect");
var ki = F("isEnabled");
var xi = F("isLoaderVisible");
var Vi = F("isVisible");
var Li = F("position");
var ji = F("text");
var Hi = F("textColor");
var at = "web_app_setup_secondary_button";
var ts = "secondary_button_pressed";
...
var ns = "settings_button_pressed";
...
var Ki = mn("mount", () => {
  Ce() || (hn(D() && P(ut) || false), Ce.set(true));
});
function hn(e) {
...
var lt = "web_app_setup_swipe_behavior";
var pt = "swipeBehavior";
var ve = c(false);
var nc = N(lt);
var It = c(true);
var oc = B(pt, lt);
var ss = J(pt, ve, lt);
var sc = ss("disableVertical", () => {
  bn(false);
});
var rc = ss("enableVertical", () => {
  bn(true);
});
var ac = oc("mount", () => {
  ve() || (bn(
...
var re = "viewport";
var rs = "web_app_request_fullscreen";
var cc = "fullscreen_failed";
var gn = "fullscreen_changed";
var as = "safe_area_changed";
var is = "content_safe_area_changed";
var cs = "viewport_changed";
var kn = "web_app_request_safe_area";
var xn = "web_app_request_content_safe_area";
var Vn = {
  left: 0,
  top: 0,
  bottom: 0,
...
var fc = _s("requestFullscreen", rs);
var dc = _s("exitFullscreen", "web_app_exit_fullscreen");
var fs = H(re);
var mc = Ze(re, Be);
function ft(e) {
  return _(() => wn()[e]);
}
var wn = K("safeAreaInsets");
var ds = ft("bottom");
var ms = ft("left");
var hs = ft("right");
var bs = ft("top");
...
var Sn = K("contentSafeAreaInsets");
var gs = dt("bottom");
var Es = dt("left");
var ws = dt("right");
var Ss = dt("top");
...
function wc() {
  const e = _t();
  e && e.cancel(), v(cs, ys), v(gn, As), v(as, Cs), v(is, vs), Be.set(false);
}
var je = c(false);
var yn = K("height");
var An = K("stableHeight");
var Ts = K("width");
var Sc = mc(
  "bindCssVars",
  (e) => {
...
var jn = "web_app_set_emoji_status";
var Rs = c();
var Tc = c();
var au = _(() => !!Rs());
var iu = h(
...
var Os = "web_app_add_to_home_screen";
var ie = { isSupported: Os };
var Ps = c();
var $c = c();
var cu = _(() => !!Ps());
var uu = h(
...
var Mc = h(
  ...
  (e) => {
    ...
    return wt.set(true), y(Dt, "phone_requested", e).then((t) => t.status).finally(() => {
      wt.set(false);
    });
  },
  {
...
var qn = "web_app_request_write_access";
var St = c(false);
var gu = h(
  "requestWriteAccess",
  (e) => {
    ...
    return St.set(true), y(qn, "write_access_requested", e).then((t) => t.status).finally(() => {
      St.set(false);
    });
  },
  {
...
var Fn = "web_app_read_text_from_clipboard";
var wu = h(
...
var Gn = "web_app_switch_inline_query";
var Au = h(
  "switchInlineQuery",
  (e, t) => {
    f(Gn, {
