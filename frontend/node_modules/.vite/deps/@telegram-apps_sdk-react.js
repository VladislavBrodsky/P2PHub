...
var z = class _z extends Error {
  constructor(t, n, r) {
    ...
    ), this.type = t, this.name = "TypedError", Object.setPrototypeOf(this, _z.prototype);
  }
};
function Gn(e) {
...
var xo = "ERR_INVALID_VALUE";
var Mo = "ERR_UNEXPECTED_VALUE";
var jo = "ERR_UNEXPECTED_TYPE";
var Jn = "ERR_PARSE";
function Yn(e, t) {
  const n = {};
  for (const r in e) {
...
var Mt = q("date", (e) => e instanceof Date ? e : new Date($e()(e) * 1e3));
function Kn(e, t) {
...
var Vo = (e) => {
  const t = $e(), n = $e(true), r = N(), o = N(true), s = Lo(true), a = Ue(mt({
...
function jc(e) {
  ...
  return i.set("tgWebAppPlatform", e.platform), i.set("tgWebAppThemeParams", Cn(e.themeParams)), i.set("tgWebAppVersion", e.version), t && i.set("tgWebAppData", t), n && i.set("tgWebAppStartParam", n), typeof r == "boolean" && i.set("tgWebAppShowSettings", r ? "1" : "0"), typeof o == "boolean" && i.set("tgWebAppBotInline", o ? "1" : "0"), typeof s == "boolean" && i.set("tgWebAppFullscreen", s ? "1" : "0"), a && i.set("tgWebAppDefaultColors", Cn(a)), i.toString();
}
function $o(e, t) {
  return q("array", (n) => {
    let r;
...
var G = class _G extends Error {
  constructor(t, n, r) {
    ...
    ), this.type = t, this.name = "TypedError", Object.setPrototypeOf(this, _G.prototype);
  }
};
function er(e) {
  return e.replace(/[A-Z]/g, (t) => `_${t.toLowerCase()}`);
...
var Go = D("date", (e) => e instanceof Date ? e : new Date(fe()(e) * 1e3));
function or(e, t) {
...
var Jo = (e) => {
  const t = fe(), n = fe(true), r = B(), o = B(true), s = Fe(true), a = O(ht({
    addedToAttachmentMenu: s,
    allowsWriteToPm: s,
    firstName: r,
    id: t,
...
var Xo = (e) => {
  const t = B(), n = B(true), r = Fe(true);
  return or({
    botInline: ["tgWebAppBotInline", r],
    defaultColors: ["tgWebAppDefaultColors", Rn(true)],
    fullscreen: ["tgWebAppFullscreen", r],
    initData: ["tgWebAppData", Jo(true)],
...
function es(e) {
  ...
  return i.set("tgWebAppPlatform", e.platform), i.set("tgWebAppThemeParams", vt(e.themeParams)), i.set("tgWebAppVersion", e.version), t && i.set("tgWebAppData", t), n && i.set("tgWebAppStartParam", n), typeof r == "boolean" && i.set("tgWebAppShowSettings", r ? "1" : "0"), typeof o == "boolean" && i.set("tgWebAppBotInline", o ? "1" : "0"), typeof s == "boolean" && i.set("tgWebAppFullscreen", s ? "1" : "0"), a && i.set("tgWebAppDefaultColors", vt(a)), i.toString();
}
var sr = O({
  eventType: B(),
  eventData: (e) => e
...
var ss = (e, t, n) => t in e ? os(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var cr = (e, t, n) => ss(e, typeof t != "symbol" ? t + "" : t, n);
var p = class ur extends Error {
  constructor(t, n, r) {
    super(
      typeof n == "object" ? n.message : n || t,
      {
...
var b = class _b extends Promise {
  constructor(t, n) {
    let r, o;
...
var hs = "ERR_METHOD_UNSUPPORTED";
var bs = "ERR_RETRIEVE_LP_FAILED";
var gs = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var br = "ERR_UNKNOWN_ENV";
var ws = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var ys = re("https://web.telegram.org");
function Ut(e, t) {
...
function In(e) {
  ...
  return b.withFn(async () => {
    if (ir(window))
      return true;
    try {
      return await $t("web_app_request_theme", "theme_changed", { timeout: 100 }), true;
    } catch {
      return false;
    }
  }, e);
...
var E = (e, t, n) => (n || (n = {}), n.postEvent || (n.postEvent = _), $t(e, t, n));
var _ = (e, t) => Er()(e, t);
function M(e) {
  return d(() => J(e, V()));
}
var ce = "ERR_POPUP_INVALID_PARAMS";
var Ht = "ERR_INVALID_URL";
var js = "ERR_INVALID_SLUG";
var Ls = "ERR_DATA_INVALID_SIZE";
var Vs = "ERR_ACCESS_DENIED";
var F = "ERR_ALREADY_REQUESTING";
var Wt = "ERR_ALREADY_OPENED";
var Ns = "ERR_ALREADY_MOUNTING";
var qs = "ERR_VARS_ALREADY_BOUND";
var Us = "ERR_NOT_AVAILABLE";
var $s = "ERR_NOT_INITIALIZED";
var Dn = "ERR_NOT_SUPPORTED";
var Fs = "ERR_NOT_MOUNTED";
var Hs = "ERR_FULLSCREEN_FAILED";
var Ws = "ERR_EMOJI_STATUS_SET_FAILED";
function xn() {
...
var ze = "web_app_setup_back_button";
var Ar = "back_button_pressed";
var Ge = "backButton";
var Tt = c(false);
var me = c(false);
var zs = M(ze);
...
var Js = zt("mount", () => {
  me() || (Gt(x() && k(Ge) || false), me.set(true));
});
function Gt(e) {
...
var Mn = "web_app_biometry_get_info";
var ta = h(
  "requestBiometry",
...
var Qe = "web_app_biometry_request_auth";
var na = "web_app_biometry_request_access";
var ra = "web_app_biometry_open_settings";
var oa = "web_app_biometry_update_token";
var Qt = "biometry_info_received";
var te = "biometry";
var sa = M(Qe);
var aa = U(te);
var ia = I(te, Qe);
...
var Xe = "closingBehavior";
var Bt = c(false);
var he = c(false);
var kr = Ze(Xe, he);
var fa = U(Xe);
var ma = kr("disableConfirmation", () => {
  Zt(false);
});
var ha = kr("enableConfirmation", () => {
  Zt(true);
});
var ba = fa("mount", () => {
  he() || (Zt(
...
var Ir = "web_app_invoke_custom_method";
var et = I("cloudStorage", Ir);
var wa = M(Ir);
var ya = et("deleteItem", (e, t) => {
...
var Ea = et("getItem", Sa);
var va = et("getKeys", (e) => oe("getStorageKeys", {}, e).then($o(N())()));
var Aa = et("setItem", (e, t, n) => oe("saveStorageValue", {
  key: e,
  value: t
}, n).then());
...
var Pe = "web_app_trigger_haptic_feedback";
var Xt = I("hapticFeedback", Pe);
var Ca = M(Pe);
var Ra = Xt(
  "impactOccurred",
  (e) => {
...
async function Mr(e, t, n) {
  ...
  if (t === "url") {
    ...
    r = e, n = t;
  return Me.set(true), E(tn, "invoice_closed", {
    ...n,
    params: { slug: r },
    capture: (o) => r === o.slug
...
var $a = A("accentTextColor");
var nn = A("bgColor");
var rn = A("buttonColor");
var Vr = A("buttonTextColor");
var Nr = A("bottomBarBgColor");
var Fa = A("destructiveTextColor");
var Ha = A("headerBgColor");
var Wa = A("hintColor");
var za = d(() => {
  const { bgColor: e } = $();
  return !e || Lr(e);
...
var Ga = A("linkColor");
var He = A("secondaryBgColor");
var Ja = A("sectionBgColor");
var Ya = A("sectionHeaderTextColor");
var Qa = A("sectionSeparatorColor");
var Ka = A("subtitleTextColor");
var Za = A("textColor");
function K(e) {
  return d(() => on()[e]);
}
...
var ge = c(false);
var Xa = K("backgroundColor");
var ei = K("hasShineEffect");
var ti = K("isEnabled");
var ni = K("isLoaderVisible");
var ri = K("isVisible");
var oi = K("text");
var si = K("textColor");
var ai = "web_app_setup_main_button";
var qr = "main_button_pressed";
var tt = "mainButton";
var sn = U(tt);
var ii = Ze(tt, ge);
var ci = sn("mount", () => {
...
var hi = mi(
  ...
  (e) => {
    ...
    return n(), $.sub(n), je.set(true), () => {
      t(Nt), $.unsub(n), je.set(false);
    };
  }
);
var $r = fi("mount", () => {
...
var Pt = "web_app_set_background_color";
var kt = "web_app_set_bottom_bar_color";
var Ve = "web_app_set_header_color";
var Gr = "visibility_changed";
var ke = "miniApp";
var pn = {
  any: [
    Pt,
...
var vi = yi(
  ...
  () => {
    if (!Ee()) {
      const e = x() && k(ke);
      $r(), Qr.ifAvailable(e ? e.backgroundColor : "bg_color"), Kr.ifAvailable(e ? e.bottomBarColor : "bottom_bar_bg_color"), Zr.ifAvailable(e ? e.headerColor : "bg_color"), rt.set(e ? e.isActive : true), w(Gr, Yr), Ee.set(true);
    }
  }
);
var Ai = Jr("ready", () => {
...
var ki = "web_app_close_scan_qr_popup";
var dn = "web_app_open_scan_qr_popup";
var Ii = "scan_qr_popup_closed";
var Oi = "qr_text_received";
var Xr = I("qrScanner", dn);
var It = Xr("close", () => {
  ee.set(false), _(ki);
});
var ee = c(false);
...
var Mi = Xr("open", xi);
var tu = Object.freeze(Object.defineProperty({
  __proto__: null,
  close: It,
  isOpened: ee,
  isSupported: Di,
...
var ve = c(false);
var ji = H("backgroundColor");
var Li = H("hasShineEffect");
var Vi = H("isEnabled");
var Ni = H("isLoaderVisible");
var qi = H("isVisible");
var Ui = H("position");
var $i = H("text");
var Fi = H("textColor");
var at = "web_app_setup_secondary_button";
var eo = "secondary_button_pressed";
var it = "secondaryButton";
var fn = I(it, at);
var Hi = Q(it, ve, at);
var Wi = M(at);
var zi = fn("mount", () => {
...
var ct = "web_app_setup_settings_button";
var to = "settings_button_pressed";
var ut = "settingsButton";
var Ot = c(false);
var Ae = c(false);
var Ki = M(ct);
var mn = I(ut, ct);
...
var Xi = mn("mount", () => {
  Ae() || (hn(x() && k(ut) || false), Ae.set(true));
});
function hn(e) {
...
var ru = Object.freeze(Object.defineProperty({
  __proto__: null,
  hide: Zi,
  isMounted: Ae,
  isSupported: Ki,
...
var pt = "web_app_setup_swipe_behavior";
var lt = "swipeBehavior";
var Ce = c(false);
var oc = M(pt);
var Dt = c(true);
var sc = I(lt, pt);
var ro = Q(lt, Ce, pt);
var ac = ro("disableVertical", () => {
  bn(false);
});
var ic = ro("enableVertical", () => {
  bn(true);
});
var cc = sc("mount", () => {
  Ce() || (bn(
...
var se = "viewport";
var oo = "web_app_request_fullscreen";
var pc = "fullscreen_failed";
var gn = "fullscreen_changed";
var so = "safe_area_changed";
var ao = "content_safe_area_changed";
var io = "viewport_changed";
var jn = "web_app_request_safe_area";
var Ln = "web_app_request_content_safe_area";
var Vn = {
  left: 0,
  top: 0,
  bottom: 0,
...
var mc = lo("requestFullscreen", oo);
var hc = lo("exitFullscreen", "web_app_exit_fullscreen");
var _o = U(se);
var bc = Ze(se, Ie);
function _t(e) {
  return d(() => yn()[e]);
}
var yn = Z("safeAreaInsets");
var fo = _t("bottom");
var mo = _t("left");
var ho = _t("right");
var bo = _t("top");
...
var Sn = Z("contentSafeAreaInsets");
var go = ft("bottom");
var wo = ft("left");
var yo = ft("right");
var So = ft("top");
...
function Ec() {
  const e = dt();
  e && e.cancel(), C(io, Eo), C(gn, vo), C(so, Ao), C(ao, Co), Ie.set(false);
}
var qe = c(false);
var En = Z("height");
var vn = Z("stableHeight");
var Ro = Z("width");
var vc = bc(
  "bindCssVars",
  (e) => {
...
var Nn = "web_app_request_emoji_status_access";
var To = c();
var Tc = c();
var iu = d(() => !!To());
var cu = h(
...
var qn = "web_app_set_emoji_status";
var Bo = c();
var Bc = c();
var uu = d(() => !!Bo());
var pu = h(
...
var Po = "web_app_add_to_home_screen";
var ie = { isSupported: Po };
var ko = c();
var Pc = c();
var lu = d(() => !!ko());
var du = h(
...
var xc = h(
  ...
  (e) => {
    ...
    return yt.set(true), E(xt, "phone_requested", e).then((t) => t.status).finally(() => {
      yt.set(false);
    });
  },
  {
...
var Fn = "web_app_request_write_access";
var St = c(false);
var Su = h(
  "requestWriteAccess",
  (e) => {
    ...
    return St.set(true), E(Fn, "write_access_requested", e).then((t) => t.status).finally(() => {
      St.set(false);
    });
  },
  {
...
var Hn = "web_app_read_text_from_clipboard";
var vu = h(
...
var zn = "web_app_switch_inline_query";
var Ru = h(
  "switchInlineQuery",
  (e, t) => {
    _(zn, {
...
function Bu(e) {
  ...
  return _("iframe_ready", { reload_supported: true }), n;
}
function Pu() {
  return (0, import_react.useMemo)(Y, []);
}
function ku(e) {
