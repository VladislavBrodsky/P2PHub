...
class SupportAgentService:
    ...
    6. **WOW FACTOR (SURPRISE VALUE):**
       ...
       - If they ask about earnings, briefly mention the 9-dimensional matrix potential.
    ...
    FALLBACK_INSTRUCTIONS: ClassVar[dict[str, list[str]]] = {
        ...
        "🤝 Partner Network & Earnings": [
            "Checklist: Share Referral Link -> Friends Join -> Earn Commissions up to 20 levels.",
